...
<div class="workers-dashboard">
    <div class="dashboard-header">
        ...
        <a href="{{ route('rrhh.create') }}" class="btn-add">
                ...
                <tr>
                    ...
                    <td>
                        <div class="action-buttons">
                            <a href="{{ route('rrhh.edit', $trabajador->id) }}" class="btn-edit" title="Editar">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form action="{{ route('rrhh.destroy', $trabajador->id) }}" method="POST" class="delete-form">
                                @csrf
                                @method('DELETE')
