   ...
   <div class="max-w-md mx-auto bg-white rounded-xl shadow-lg overflow-hidden md:max-w-2xl">
       <div class="md:flex">
           <div class="p-8 w-full">
               <h1 class="text-2xl font-bold text-center text-gray-900 mb-8">Registrar Quincena</h1>
               
               <form action="{{ route('rrhh.quincenas.store') }}" method="POST" class="space-y-6">
                   @csrf

                   <div>
                       <label class="block text-sm font-semibold text-gray-700">Trabajador</label>
                       <select name="trabajador_id" required class="mt-2 block w-full rounded-lg border-gray-300 bg-gray-50 py-2.5 px-4 text-gray-900 focus:ring-2 focus:ring-teal-600 focus:border-transparent">
                   ...
                   <div>
                       ...
                       <div class="mt-2 relative rounded-lg shadow-sm">
                           ...
                           <input type="number" name="monto" step="0.01" min="0" required
                               class="block w-full pl-7 rounded-lg border-gray-300 bg-gray-50 py-2.5 px-4 text-gray-900 focus:ring-2 focus:ring-teal-600 focus:border-transparent">
                       </div>
                   </div>
                   ...
                   <div>
                       ...
                       <input type="month" name="mes" required
                           class="mt-2 block w-full rounded-lg border-gray-300 bg-gray-50 py-2.5 px-4 text-gray-900 focus:ring-2 focus:ring-teal-600 focus:border-transparent">
                   </div>
