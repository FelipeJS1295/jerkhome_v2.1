...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('configuracion.clientes.create') }}" 
            ...
            <table class="w-full whitespace-nowrap">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-sm text-gray-900">{{ $cliente->rut }}</td>
                        ...
                        <td class="px-6 py-4 text-sm text-right space-x-2">
                            <div class="flex justify-end gap-2">
                                <a href="{{ route('configuracion.clientes.edit', $cliente->id) }}" 
                                ...
                                <form action="{{ route('configuracion.clientes.destroy', $cliente->id) }}" 
                                      method="POST" 
                                      class="inline-block"
