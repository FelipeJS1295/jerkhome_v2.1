...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-gray-900">Lista de Insumos</h1>
            ...
            <table class="w-full whitespace-nowrap">
                <thead>
                    <tr class="bg-gray-50">
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">SKU Padre</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">SKU hIJO</th>
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4 text-sm text-gray-900">{{ $insumo->id }}</td>
                        <td class="px-6 py-4 text-sm text-gray-900">{{ $insumo->sku_padre }}</td>
                        <td class="px-6 py-4 text-sm text-gray-900">{{ $insumo->sku_hijo }}</td>
                        <td class="px-6 py-4 text-sm text-gray-900">{{ $insumo->nombre }}</td>
                        <td class="px-6 py-4 text-sm text-gray-900">{{ $insumo->unidad_medida }}</td>
